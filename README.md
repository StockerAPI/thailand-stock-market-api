# Thailand stock market API

Real-time Thailand stock market API with WebSocket, OHLCV, and snapshot endpoints for SET.

## Build With Thailand Market Data

Kun Data provides a token-authenticated API stack for developers who need Thailand market data in products that must load fast, stream live prices, and support charting or screening workflows.

This repository is focused on Thailand coverage with support for SET and is designed for teams building broker dashboards, watchlists, quant tools, stock screeners, mobile apps, and market overview pages.

## Why Developers Search For This

Developers usually need one or more of these:

- Real-time Thailand stock market API
...
`Thailand stock market API | SET API | Thailand stock data API | Thailand OHLCV API`
...
### Does this support real-time Thailand market data?
...
If you need Thailand market data coverage for SET, start with the product page and documentation:
