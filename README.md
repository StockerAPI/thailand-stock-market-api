...
Kun Data provides real-time market data for Thailand through a token-authenticated API stack designed for charting tools, watchlists, market overview pages, brokerage dashboards, and quant workflows.

This repository focuses on Thailand market coverage with support for SET.

## API Capabilities

- Real-time WebSocket market data for Thailand
...
This repository is designed to make Thailand market API coverage easier to discover and evaluate.
