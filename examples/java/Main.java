...
public class Main {
    ...
    private static final String MARKET = "TH";
    private static final String EXCHANGE = "SET";
    private static final String SYMBOL = "SET:000040";
                ...
                .buildAsync(URI.create(WS_URL), new WebSocket.Listener() {
                    ...
                    public void onOpen(WebSocket webSocket) {
                        String subscribeJson = "{\"action\":\"subscribe\",\"market\":\"" + MARKET
                                + "\",\"exchange\":\"" + EXCHANGE
                                + "\",\"symbols\":[\"SET:000040\",\"SET:005930\"],\"replay\":\"last\"}";
